// GOLD SOURCE (PF-152): a real component from this project, copied verbatim (paired with
// angular-component-gold-source.html), demonstrating standalone: true, inject() for DI, and
// modern @if control flow with Tailwind utility classes (no inline styles) in its template.
// Doesn't demonstrate @for specifically -- this component doesn't render a list. See any
// *.component.html under src/app/features/*/components/ that renders a p-table or repeated
// items for a real @for example if one is specifically needed.
//
// Original file: reconcile-dialog.component.ts / reconcile-dialog.component.html
import {
  Component,
  computed,
  effect,
